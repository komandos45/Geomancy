...
public class GeoManaProvider implements ICapabilitySerializable<NBTBase>  {

	@CapabilityInject(IGeoMana.class) 
	public static final Capability<IGeoMana> MANA_CAP = null;
	
	private IGeoMana instance = MANA_CAP.getDefaultInstance(); 
